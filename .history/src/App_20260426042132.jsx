...
function App() {
  ...
  const canScanFile = Boolean(uploadedFile) && !loading;
  ...
  function handleSubmit(event) {
    ...
    const sourceType = isEmail(normalized) ? 'Email' : 'URL or IP';
        ...
        <section className="hero" aria-labelledby="hero-title">
          ...
          <form className="search-shell" onSubmit={handleSubmit}>
            <input
              ...
              placeholder="Enter a URL, IP address, or email..."
              aria-label="Enter a URL, IP address, or email"
            />
